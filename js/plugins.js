...
Fluid.plugins = {
  ...
  initFancyBox: function(selector) {
    ...
    // 针对单独页面的图片展示，代码冗余有待优化
    jQuery(selector || '.page-content img').each(function() {
  ...
  initCopyCode: function() {
    ...
    var copyHtml = '';
     // 自定义添加代码语言元素
    copyHtml += '<p class="code_block_lang">None</p>';
      // 添加收回button 
    copyHtml += '<i class="iconfont icon-arrow-down-bold" id="block-func-icon-down" type="button"></i>';
    copyHtml += '<i class="iconfont icon-arrow-up-bold" id="block-func-icon-up" type="button"></i>';
